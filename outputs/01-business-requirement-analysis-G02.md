...
21. **Booking Cancellation Rule:** A booking may be cancelled by the requester who submitted it or by authorized staff members, provided that the booking status is `Pending`, or `Approved`. Cancelled bookings shall remain stored in the system to preserve historical records and auditability.
---
