...
## 3. Updated Entity-Relationship Diagram — Relationships Section
 
Drop this block in place of the `%% ── Relationships ──` section in the
existing §3 Mermaid code (entity blocks are unaffected and should be kept
as-is from the last artifact).
...
## 4. Relationship Delta Summary (corrected)
