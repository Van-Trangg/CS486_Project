...
| P2-BR-06 | When an advisory is escalated to out-of-service, already-approved bookings overlapping the maintenance period must be identifiable for staff follow-up. | New. | Phase 2, Maintenance impact levels, additional rule 3. | Preserve the ability to find affected approved bookings and their requesters; do not assume automatic cancellation. |
