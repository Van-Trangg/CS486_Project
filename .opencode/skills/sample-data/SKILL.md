...
- **Bookings**: All seeded Bookings with status "Completed" must have a corresponding `USAGE_SESSION` entry to simulate a ooking that had previously been approved, taken place and marked for completion.
